    ...
    daymoney.prototype._loadDate = function() {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (priceList) {
                ...
                if(priceList[tdday]){
                    var a=priceList[tdday];//380_10//价格和数字在一行太长 分割一下在两行显示
                    var b=a.split("_"); //380_10
                    aTd[i].setAttribute('data-money', b[0]);
                    aTd[i].innerHTML = '<span class="am-daymoney-month-head">' + da + '</span><br/><span class="daymoney-month-body">￥' + b[0] + '</span><br/><span class="daymoney-month-body2">' + b[1] + '间</span>';                    
